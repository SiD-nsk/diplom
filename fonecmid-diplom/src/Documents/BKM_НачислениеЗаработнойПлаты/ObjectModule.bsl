...
Процедура СформироватьДвиженияПоОсновнымНачислениям() 
	...
	Запрос.Текст = 
		...
		|	BKM_НачислениеЗаработнойПлатыОсновныеНачисления.ГрафикРабот КАК ГрафикРабот,
		|	ВЫБОР
		|		КОГДА BKM_НачислениеЗаработнойПлатыОсновныеНачисления.ВидРасчета = ЗНАЧЕНИЕ(ПланВидовРасчета.BKM_ОсновныеНачисления.Отпуск)
